                    ...
                    use: [
                        {
                            ...
                            options: {
                                ...
                                publicPath: url => url.replace(`assets/images/${razorPages}/`, "/dist/assets/images/"),
                                outputPath: url => url.replace(`assets/images/${razorPages}/`, "assets/images/")
                            }
                        }
                    ]
                },
                    ...
                    use: [
                        {
                            ...
                            options: {
                                ...
                                publicPath: url => url.replace(`assets/fonts/${razorPages}/`, "/dist/assets/fonts/"),
                                outputPath: url => url.replace(`assets/fonts/${razorPages}/`, "assets/fonts/")
                            }
                        }
                    ]
                }
